...
/**
 * Class Connect
 * @package Internship\SocialLogin\Controller\Twitter
 */
class Connect extends \Magento\Framework\App\Action\Action
{
     ...
     * @param \Internship\SocialLogin\Model\Twitter\Client $client
     * @param \Internship\SocialLogin\Helper\SocialLogin $helper
     */
    public function __construct(
        \Magento\Framework\App\Action\Context $context,
        \Magento\Customer\Model\Session $customerSession,
        \Internship\SocialLogin\Model\Twitter\Client $client,
        \Internship\SocialLogin\Helper\SocialLogin $helper
    ) {
    ...
    protected function connect()
    {
        ...
        if ($customer->getId()) {
            $data = [
                ...
                'internship_sociallogin_type' => $twitter
            ];
