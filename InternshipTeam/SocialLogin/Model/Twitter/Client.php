<?php
namespace InternshipTeam\SocialLogin\Model\Twitter;
...
class Client
{
    ...
    const XML_PATH_ENABLED = 'internshipTeam/twitter/enabled';
    const XML_PATH_CLIENT_ID = 'internshipTeam/twitter/client_id';
    const XML_PATH_CLIENT_SECRET = 'internshipTeam/twitter/client_secret';
